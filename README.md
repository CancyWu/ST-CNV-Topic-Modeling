...
7. **End-to-end optimization.** Reconstruction loss is backpropagated through $$X̂$$, \(B\), \(Z\), and the GAT encoder. Thus, the spatial representation and genomic interpretation are learned jointly.
